...
resource "aws_instance" "ec2" {
  ...
  user_data              = templatefile("./modules/templates/userdata.txt", { pri = var.network_interface_pri, sec1 = var.network_interface_sec1, sec2 = var.network_interface_sec2, hostname = var.mongodb[4]})
}
