...
mongodb = {
  ...
  mongodb_1 = [0, "t2.large", "", "cl0a0001", "mongodb-1", 0, 0] 
  mongodb_2 = [0, "t2.large", "", "cl0a0002", "mongodb-2", 0, 0] 
  mongodb_3 = [0, "t3.large", "", "cl0a0003", "mongodb-3", 0, 0]
}
...
mongodb_main_security_group = {
  mongodb_main_sg = ["mongodb_main_sg", "MongoDB Server Main Security Group"]
}
mongodb_main_sg_ingress = {
    port_22 = [22, 22, "tcp", "SSH from jumpbox", "10.231.96.0/19", true]
}

mongodb_main_sg_egress = {
    port_22 = [22, 22, "tcp", "SSH to jumpbox", "10.231.96.0/19", true]

}

create_backup = true
restore_backup_to_ebs = true
